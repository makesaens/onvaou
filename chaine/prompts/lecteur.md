...
- IMPACT_CAMION : le camping-car est touché, rayé, cassé, accroché. detail: { "zone": une valeur parmi ["avant","aile-avant-gauche","aile-avant-droite","flanc-gauche-avant","flanc-gauche-arriere","flanc-droit-avant","flanc-droit-arriere","arriere","toit","capucine","retro-gauche","retro-droit","marchepied","roue"] ou "inconnue", "gravite": "rayure" | "choc" | "casse", "quoi": "..." }.
